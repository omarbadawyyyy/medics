...
class KidneyAnalysisPage extends StatefulWidget {
  const KidneyAnalysisPage({super.key});

  @override
  _KidneyAnalysisPageState createState() => _KidneyAnalysisPageState();
}

class _KidneyAnalysisPageState extends State<KidneyAnalysisPage> with SingleTickerProviderStateMixin {
  ...
  void _showInitialMessage() {
    setState(() {
      _analysisResult = 'Upload kidney reports for analysis.';
    });
  }
  ...
  Future<String> _analyzeFiles() async {
    ...
    try {
      ...
      parts.add({
        "text": "هذه ملفات (صور أو PDF) لتقارير طبية متعلقة بالكلى. قم بتحليلها كتقرير واحد واتبع التعليمات:\n"
            "1. قدم تشخيصًا عامًا موجزًا بالعربية تحت عنوان 'التشخيص العام:'، مع ذكر أمراض الكلى المحتملة مثل مرض الكلى المزمن (CKD)، الإصابة الكلوية الحادة (AKI)، أو الاعتلال الكلوي السكري بناءً على القيم. مثال: 'التشخيص العام: ارتفاع الكرياتينين يشير إلى احتمال مرض الكلى المزمن أو الإصابة الكلوية الحادة.' إذا كانت القيم طبيعية، اكتب: 'التشخيص العام: الكلى سليمة.'\n"
            "2. تحت عنوان 'القيم غير الطبيعية:'، اذكر فقط القيم الرقمية غير الطبيعية (مثل الكرياتينين، GFR، الألبومين، البوتاسيوم) مع وحداتها، دون النطاقات الطبيعية أو أرقام الصفحات. مثال: 'القيم غير الطبيعية:\n- الكرياتينين: 1.5 مجم/ديسيلتر\n- GFR: 50 مل/دقيقة/1.73 م²'. إذا لم توجد قيم غير طبيعية، اكتب 'لا توجد قيم غير طبيعية.'\n"
                  ...
                  onPressed: () {
                    showDialog(
                      ...
                      builder: (context) => AlertDialog(
                        ...
                        content: Text(
                          '1. Upload kidney report images or PDFs.\n'
