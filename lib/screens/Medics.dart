...
class MedicsPage extends StatefulWidget {
  @override
  _MedicsPageState createState() => _MedicsPageState();
}

class _MedicsPageState extends State<MedicsPage> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    // ✅ تهيئة AnimationController مع مدة أطول للانيميشن
    ...
    _scaleAnimation = Tween<double>(begin: 0.5, end: 1.0).animate(
      CurvedAnimation(
        parent: _controller,
        curve: Curves.elasticOut, // ✅ تأثير مرن على الانيميشن
      ),
    );
    ...
    _slideAnimation = Tween<Offset>(begin: Offset(0, 1), end: Offset.zero).animate(
      CurvedAnimation(
        parent: _controller,
        curve: Curves.easeOutExpo, // ✅ تأثير انزلاق ناعم
      ),
    );
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // ✅ تحسين النصوص مع تأثير Fade + Scale
              FadeTransition(
                opacity: _fadeAnimation,
                child: ScaleTransition(
                  scale: _scaleAnimation,
              ...
              // ✅ تحسين شكل الأزرار مع تأثير Slide
